...
import cn.nihility.redis.service.SetCacheService;
...
public class SetCacheServiceImpl implements SetCacheService {
    ...
    public SetCacheServiceImpl(RedisTemplate<String, Object> redisTemplate) {
    ...
    public long size(String key) {
        Long size;
        return (size = redisTemplate.opsForSet().size(key)) == null ? 0 : size;
    }
    ...
    public boolean isMember(String key, Object obj) {
        return Boolean.TRUE == redisTemplate.opsForSet().isMember(key, obj);
    }
    ...
    public boolean move(String key, Object value, String destValue) {
        return Boolean.TRUE == redisTemplate.opsForSet().move(key, value, destValue);
    }
    ...
    public long remove(String key, Object... values) {
        Long size;
        return (size = redisTemplate.opsForSet().remove(key, values)) == null ? 0 : size;
    }
     ...
     */
    @Override
    public Set<Object> difference(String key, List<String> list) {
     ...
     */
    @Override
    public void intersectAndStore(String key, List<String> otherKey, String destKey) {
        redisTemplate.opsForSet().intersectAndStore(key, otherKey, destKey);
    }
     ...
     */
    @Override
    public Set<Object> union(String key, List<String> list) {
     ...
     */
    @Override
    public void unionAndStore(String key, List<String> list, String destKey) {
    ...
    public long getExpire(String key) {
        Long time;
        return (time = redisTemplate.getExpire(key)) == null ? 0 : time;
    }
}
