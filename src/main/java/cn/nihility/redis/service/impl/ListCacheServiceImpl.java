...
import cn.nihility.redis.service.ListCacheService;
...
public class ListCacheServiceImpl implements ListCacheService {
    ...
    public ListCacheServiceImpl(RedisTemplate<String, Object> redisTemplate) {
    ...
    public boolean lPushIfPresent(String key, Object object) {
        try {
            ...
            log.error("lPushIfPresent error", e);
            return false;
        }
    }
    ...
    public boolean rPushIfPresent(String key, Object object) {
        try {
            ...
            log.error("rPushIfPresent error", e);
            return false;
        }
    }
    ...
    public long remove(String key, long count, Object object) {
        Long val;
        return (val = redisTemplate.opsForList().remove(key, count, object)) == null ? 0 : val;
    }
