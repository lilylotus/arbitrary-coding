...
import cn.nihility.redis.service.ZSetCacheService;
...
public class ZSetCacheServiceImpl implements ZSetCacheService {
    ...
    public ZSetCacheServiceImpl(RedisTemplate<String, Object> redisTemplate) {
    ...
    public long zCard(String key) {
        Long size;
        return (size = redisTemplate.opsForZSet().zCard(key)) == null ? 0 : size;
    }
    ...
    public long count(String key, double min, double max) {
        Long size;
        return (size = redisTemplate.opsForZSet().count(key, min, max)) == null ? 0 : size;
    }
    ...
    public double incrementScore(String key, Object value, double delta) {
        Double score;
        return (score = redisTemplate.opsForZSet().incrementScore(key, value, delta)) == null ? 0D : score;
    }
    ...
    public double score(String key, Object o) {
        Double score;
        return (score = redisTemplate.opsForZSet().score(key, o)) == null ? 0D : score;
    }
    ...
    public long rank(String key, Object o) {
        Long rank;
        return (rank = redisTemplate.opsForZSet().rank(key, o)) == null ? -1 : rank;
    }
    ...
    public long reverseRank(String key, Object o) {
        Long rank;
        return (rank = redisTemplate.opsForZSet().reverseRank(key, o)) == null ? -1 : rank;
    }
    ...
    public long intersectAndStore(String key, String otherKey, String destKey) {
        Long val;
        return (val = redisTemplate.opsForZSet().intersectAndStore(key, otherKey, destKey)) == null ? 0 : val;
    }
     ...
     */
    @Override
    public long intersectAndStore(String key, List<String> list, String destKey) {
        Long val;
        return (val = redisTemplate.opsForZSet().intersectAndStore(key, list, destKey)) == null ? 0 : val;
    }
    ...
    public long unionAndStore(String key, String otherKey, String destKey) {
        Long val;
        return (val = redisTemplate.opsForZSet().unionAndStore(key, otherKey, destKey)) == null ? 0 : val;
    }
     ...
     */
    @Override
    public long unionAndStore(String key, List<String> list, String destKey) {
        Long val;
        return (val = redisTemplate.opsForZSet().unionAndStore(key, list, destKey)) == null ? 0 : val;
    }
    ...
    public long remove(String key, Object... values) {
        Long val;
        return (val = redisTemplate.opsForZSet().remove(key, values)) == null ? 0 : val;
    }
    ...
    public long removeRangeByScore(String key, double min, double max) {
        Long val;
        return (val = redisTemplate.opsForZSet().removeRangeByScore(key, min, max)) == null ? 0 : val;
    }
    ...
    public long removeRange(String key, long start, long end) {
        Long val;
        return (val = redisTemplate.opsForZSet().removeRange(key, start, end)) == null ? 0 : val;
    }
    ...
    public long getExpire(String key) {
        Long expire;
        return (expire = redisTemplate.getExpire(key)) == null ? -1 : expire;
    }
}
