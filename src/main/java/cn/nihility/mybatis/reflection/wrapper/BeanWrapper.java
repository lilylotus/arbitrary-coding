...
import cn.nihility.mybatis.reflection.SystemMetaObject;
import cn.nihility.mybatis.reflection.exception.ExceptionUtil;
    ...
    public boolean hasGetter(String name) {
        ...
        if (prop.hasNext()) {
            if (metaClass.hasGetter(prop.getIndexedName())) {
                MetaObject metaObject = this.metaObject.metaObjectForProperty(prop.getIndexedName());
                if (SystemMetaObject.NULL_META_OBJECT == metaObject) {
